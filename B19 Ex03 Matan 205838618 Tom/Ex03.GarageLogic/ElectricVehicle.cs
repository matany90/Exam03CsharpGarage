...
namespace Ex03.GarageLogic
{
    abstract class ElectricVehicle : Vehicle
    {
        ...
        public ElectricVehicle(string i_ModelName, string i_LicenseNumber, float i_BatteryTimeLeftByHours, float i_MaxBatteryTime, int i_NumberOfWheels, Wheel i_Wheel) : base(i_ModelName, i_LicenseNumber, 100 * (i_BatteryTimeLeftByHours / i_MaxBatteryTime), i_NumberOfWheels, i_Wheel)
        {
