...
namespace Ex03.GarageLogic
{
    class ElectricCar : ElectricVehicle
    {
        ...
        public ElectricCar(string i_ModelName, string i_LicenseNumber, float i_BatteryTimeLeftByHours, float i_MaxBatteryTime, eCarColor i_Color, eDoorsNumber i_DoorNumber, int i_NumberOfWheels, Wheel i_Wheel) : base(i_ModelName, i_LicenseNumber, i_BatteryTimeLeftByHours, i_MaxBatteryTime, i_NumberOfWheels, i_Wheel)
        {
